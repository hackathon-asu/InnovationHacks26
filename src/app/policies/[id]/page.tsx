    ...
    <main className="mx-auto max-w-7xl px-6 py-8 space-y-6">
      <div>
        <div className="flex items-center gap-3">
          <h1 className="text-2xl font-semibold font-[var(--font-montserrat)]">
            {String(policy.title ?? policy.filename ?? 'Policy Detail')}
          </h1>
          <span className="rounded-full border border-[#91BFEB] bg-[#dceeff] px-2.5 py-0.5 text-xs font-semibold text-[#15173F]">
